...
export declare const ExternalAddressesApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    requestExternalFaucetFunds: (networkId: string, addressId: string, assetId?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const ExternalAddressesApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    requestExternalFaucetFunds(networkId: string, addressId: string, assetId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FaucetTransaction>>;
};
/**
...
export declare class ExternalAddressesApi extends BaseAPI implements ExternalAddressesApiInterface {
     ...
     * @memberof ExternalAddressesApi
     */
    requestExternalFaucetFunds(networkId: string, addressId: string, assetId?: string, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<FaucetTransaction, any>>;
}
/**
...
export declare const SmartContractsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listSmartContracts: (walletId: string, addressId: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const SmartContractsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listSmartContracts(walletId: string, addressId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SmartContractList>>;
    /**
     * Perform a read operation on a smart contract without creating a transaction
     * @summary Read data from a smart contract
     * @param {string} networkId
...
export declare class SmartContractsApi extends BaseAPI implements SmartContractsApiInterface {
     ...
     * @memberof SmartContractsApi
     */
    listSmartContracts(walletId: string, addressId: string, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<SmartContractList, any>>;
    /**
     * Perform a read operation on a smart contract without creating a transaction
     * @summary Read data from a smart contract
     * @param {string} networkId
 ...
 * @extends {BaseAPI}
 */
export declare class ValidatorsApi extends BaseAPI implements ValidatorsApiInterface {
    /**
     * Get a validator belonging to the user for a given network, asset and id.
     * @summary Get a validator belonging to the CDP project
     * @param {string} networkId The ID of the blockchain network.
 ...
 * @export
 */
export declare const WalletStakeApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
 ...
 * @export
 */
export declare const WalletStakeApiFp: (configuration?: Configuration) => {
    /**
     * Broadcast a staking operation.
     * @summary Broadcast a staking operation
     * @param {string} walletId The ID of the wallet the address belongs to.
 ...
 * @export
 */
export declare const WalletStakeApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Broadcast a staking operation.
     * @summary Broadcast a staking operation
     * @param {string} walletId The ID of the wallet the address belongs to.
 ...
 * @extends {BaseAPI}
 */
export declare class WalletStakeApi extends BaseAPI implements WalletStakeApiInterface {
    /**
     * Broadcast a staking operation.
     * @summary Broadcast a staking operation
     * @param {string} walletId The ID of the wallet the address belongs to.
