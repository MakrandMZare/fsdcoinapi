...
const ExternalAddressesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        requestExternalFaucetFunds: async (networkId, addressId, assetId, options = {}) => {
            // verify required parameter 'networkId' is not null or undefined
...
const ExternalAddressesApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async requestExternalFaucetFunds(networkId, addressId, assetId, options) {
...
const ExternalAddressesApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        requestExternalFaucetFunds(networkId, addressId, assetId, options) {
...
class ExternalAddressesApi extends base_1.BaseAPI {
     ...
     */
    requestExternalFaucetFunds(networkId, addressId, assetId, options) {
        return (0, exports.ExternalAddressesApiFp)(this.configuration).requestExternalFaucetFunds(networkId, addressId, assetId, options).then((request) => request(this.axios, this.basePath));
    }
}
